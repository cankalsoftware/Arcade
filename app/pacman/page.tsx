    ...
    return (
        <div className="min-h-screen bg-gray-950 flex flex-col items-center py-8 px-4 gap-4 text-white relative">
            <div className="w-full max-w-7xl flex items-center justify-between">
                <Link href="/">
                    <Button variant="ghost" className="text-white hover:text-pink-400 gap-2">
                        <ArrowLeft size={20} /> Back to Arcade
                    </Button>
                </Link>
                <h1 className="text-4xl font-mono text-pink-400 absolute left-1/2 -translate-x-1/2">PAC-MAN</h1>
